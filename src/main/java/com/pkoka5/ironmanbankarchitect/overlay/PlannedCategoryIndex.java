 ...
 * without walking the whole preview per frame. Categories keep their preset
 * order, which is what gives each one a stable colour and legend position.</p>
 */
final class PlannedCategoryIndex
{
	...
	private PlannedCategoryIndex(List<String> categoryNames,
	...
	static PlannedCategoryIndex from(BankOrganizationPreview preview)
	{
		...
		return new PlannedCategoryIndex(names, indexByItemId);
	}
