...
public final class BankLayoutOptions
{
	...
	/** The same options with the player's saved block orders attached. */
	...
	/** How the combat gear tab is laid out; the best-in-slot matrix by default. */
