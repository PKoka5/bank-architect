...
| 15 | Original screenshots | done | Five maintainer-captured screenshots (2026-08-29) in `docs/screenshots/`: the tab layout editor, assign mode, the blueprint dialog, sorting guidance, and recovery guidance. Title bars with the account name were cropped and chat areas blacked out before publication review. |
...
| 34 | Screenshot requirement and presentation rules | done | Live Plugin Hub README rechecked on 2026-07-19: no hard screenshot format is published; the README ships five redacted screenshots. Respond to any reviewer feedback. |
